...
import {category_create, category_update, category_delete, category_toggle} from '../app/category-actions';
import {expense_create, expense_update, expense_destroy, expense_toggle} from '../app/expense-actions';

import CategoryCreate from './categories/category-create.js';
import CategoryDisplay from './categories/category-display.js';
import CategoryUpdate from './categories/category-update.js';
